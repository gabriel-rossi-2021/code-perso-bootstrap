...
"""
    Nom : details_collaborateurs_afficher
    Auteur : OM 2021.05.01
    Définition d'une "route" /details_collaborateurs_afficher
...
@obj_mon_application.route("/details_collaborateurs_afficher/<int:id_details_collaborateurs_sel>", methods=['GET', 'POST'])
def details_collaborateurs_afficher(id_details_collaborateurs_sel):
    ...
    return render_template("details_collaborateurs/details_collaborateurs_afficher.html", data=data_genres_films_afficher)
...
"""
    ...
    Récupère la liste de tous les genres du film sélectionné par le bouton "MODIFIER" de "details_collaborateurs_afficher.html"
...
def edit_genre_film_selected():
    ...
    return render_template("details_collaborateurs/details_collaborateurs_modifier_tags_dropbox.html",
...
def update_genre_film_selected():
    ...
    return redirect(url_for('details_collaborateurs_afficher', id_details_collaborateurs_sel=id_details_collaborateurs_selected))
